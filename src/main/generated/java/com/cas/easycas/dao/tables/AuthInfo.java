...
public class AuthInfo extends TableImpl<AuthInfoRecord> {
    ...
    private static final long serialVersionUID = 575653780;
     ...
     */
    public final TableField<AuthInfoRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('auth_info_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
     ...
     */
    @Override
    public Identity<AuthInfoRecord, Long> getIdentity() {
