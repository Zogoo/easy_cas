...
public class Users extends TableImpl<UsersRecord> {
    ...
    private static final long serialVersionUID = 568842132;
     ...
     */
    public final TableField<UsersRecord, String> USER_NAME = createField("user_name", org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>public.users.company_id</code>.
     */
    public final TableField<UsersRecord, Long> COMPANY_ID = createField("company_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public List<ForeignKey<UsersRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<UsersRecord, ?>>asList(Keys.USERS__USERS_COMPANY_ID_FKEY);
    }

    public Companies companies() {
        return new Companies(this, Keys.USERS__USERS_COMPANY_ID_FKEY);
    }
