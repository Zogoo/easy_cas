...
public class ClientCertificateRuleRecord extends UpdatableRecordImpl<ClientCertificateRuleRecord> implements Record5<Long, Long, Long, Timestamp, Timestamp> {

    private static final long serialVersionUID = -253610826;

    /**
     * Setter for <code>public.client_certificate_rule.id</code>.
     */
    public ClientCertificateRuleRecord setId(Long value) {
        set(0, value);
        return this;
    }
     ...
     */
    @Override
    public ClientCertificateRuleRecord value1(Long value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public ClientCertificateRuleRecord values(Long value1, Long value2, Long value3, Timestamp value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ClientCertificateRuleRecord(Long id, Long chainId, Long rootCertificateId, Timestamp createdAt, Timestamp updatedAt) {
        super(ClientCertificateRule.CLIENT_CERTIFICATE_RULE);
