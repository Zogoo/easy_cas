...
public class ClientCertificateRule extends TableImpl<ClientCertificateRuleRecord> {
    ...
    private static final long serialVersionUID = 448664795;
     ...
     */
    public final TableField<ClientCertificateRuleRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('client_certificate_rule_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
     ...
     */
    @Override
    public Identity<ClientCertificateRuleRecord, Long> getIdentity() {
