...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record4<Integer, Long, Timestamp, Timestamp> {

    private static final long serialVersionUID = 2027587895;
     ...
     */
    @Override
    public UsersRecord values(Integer value1, Long value2, Timestamp value3, Timestamp value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UsersRecord(Integer id, Long companyId, Timestamp createdAt, Timestamp updatedAt) {
        super(Users.USERS);
