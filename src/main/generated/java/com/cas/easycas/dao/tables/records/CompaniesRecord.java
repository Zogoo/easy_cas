...
public class CompaniesRecord extends UpdatableRecordImpl<CompaniesRecord> implements Record2<Long, String> {

    private static final long serialVersionUID = 1045318032;

    /**
     * Setter for <code>public.companies.id</code>.
     */
    public CompaniesRecord setId(Long value) {
        set(0, value);
        return this;
    }
     ...
     */
    @Override
    public CompaniesRecord values(Long value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public CompaniesRecord(Long id, String name) {
        super(Companies.COMPANIES);
