...
public class OtpRule extends TableImpl<OtpRuleRecord> {
    ...
    private static final long serialVersionUID = 755808949;
     ...
     */
    public final TableField<OtpRuleRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('otp_rule_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");
     ...
     */
    @Override
    public Identity<OtpRuleRecord, Integer> getIdentity() {
