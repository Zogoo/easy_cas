...
public class DeviseRule extends TableImpl<DeviseRuleRecord> {
    ...
    private static final long serialVersionUID = 494018189;
     ...
     */
    public final TableField<DeviseRuleRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('devise_rule_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
     ...
     */
    @Override
    public Identity<DeviseRuleRecord, Long> getIdentity() {
