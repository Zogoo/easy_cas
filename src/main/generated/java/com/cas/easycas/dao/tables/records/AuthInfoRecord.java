...
public class AuthInfoRecord extends UpdatableRecordImpl<AuthInfoRecord> implements Record7<Integer, Timestamp, Object, Timestamp, Timestamp, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1437570266;

    /**
     * Setter for <code>public.auth_info.id</code>.
     */
    public AuthInfoRecord setId(Integer value) {
        set(0, value);
        return this;
    }
     ...
     */
    @Override
    public Row7<Integer, Timestamp, Object, Timestamp, Timestamp, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, Timestamp, Object, Timestamp, Timestamp, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public AuthInfoRecord value1(Integer value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public AuthInfoRecord values(Integer value1, Timestamp value2, Object value3, Timestamp value4, Timestamp value5, Timestamp value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AuthInfoRecord(Integer id, Timestamp lastSignInAt, Object lastSignInIp, Timestamp lockedAt, Timestamp unlockedAt, Timestamp createdAt, Timestamp updatedAt) {
        super(AuthInfo.AUTH_INFO);
