...
public class PasswordRule extends TableImpl<PasswordRuleRecord> {
    ...
    private static final long serialVersionUID = 1355814386;
     ...
     */
    public final TableField<PasswordRuleRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('password_rule_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");
     ...
     */
    @Override
    public Identity<PasswordRuleRecord, Integer> getIdentity() {
