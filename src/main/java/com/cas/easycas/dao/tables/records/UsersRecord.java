...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record5<Integer, String, Long, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1681961981;
     ...
     */
    @Override
    public UsersRecord values(Integer value1, String value2, Long value3, Timestamp value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UsersRecord(Integer id, String userName, Long companyId, Timestamp createdAt, Timestamp updatedAt) {
        super(Users.USERS);
