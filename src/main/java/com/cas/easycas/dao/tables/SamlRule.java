...
public class SamlRule extends TableImpl<SamlRuleRecord> {
    ...
    private static final long serialVersionUID = -2123109289;
     ...
     */
    public final TableField<SamlRuleRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('saml_rule_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");
     ...
     */
    @Override
    public Identity<SamlRuleRecord, Integer> getIdentity() {
