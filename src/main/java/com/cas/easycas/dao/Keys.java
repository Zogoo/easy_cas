...
public class Keys {
    ...
    public static final Identity<AdRuleRecord, Integer> IDENTITY_AD_RULE = Identities0.IDENTITY_AD_RULE;
    public static final Identity<AuthChainRecord, Integer> IDENTITY_AUTH_CHAIN = Identities0.IDENTITY_AUTH_CHAIN;
    public static final Identity<AuthInfoRecord, Integer> IDENTITY_AUTH_INFO = Identities0.IDENTITY_AUTH_INFO;
    public static final Identity<ClientCertificateRuleRecord, Integer> IDENTITY_CLIENT_CERTIFICATE_RULE = Identities0.IDENTITY_CLIENT_CERTIFICATE_RULE;
    public static final Identity<DeviseRuleRecord, Integer> IDENTITY_DEVISE_RULE = Identities0.IDENTITY_DEVISE_RULE;
    public static final Identity<DuoRuleRecord, Integer> IDENTITY_DUO_RULE = Identities0.IDENTITY_DUO_RULE;
    public static final Identity<FidoRuleRecord, Integer> IDENTITY_FIDO_RULE = Identities0.IDENTITY_FIDO_RULE;
    public static final Identity<IpRuleRecord, Integer> IDENTITY_IP_RULE = Identities0.IDENTITY_IP_RULE;
    public static final Identity<LoginIpRecord, Integer> IDENTITY_LOGIN_IP = Identities0.IDENTITY_LOGIN_IP;
    public static final Identity<OtpRuleRecord, Integer> IDENTITY_OTP_RULE = Identities0.IDENTITY_OTP_RULE;
    public static final Identity<PasswordRuleRecord, Integer> IDENTITY_PASSWORD_RULE = Identities0.IDENTITY_PASSWORD_RULE;
    public static final Identity<RootCertificateRecord, Integer> IDENTITY_ROOT_CERTIFICATE = Identities0.IDENTITY_ROOT_CERTIFICATE;
    public static final Identity<SamlRuleRecord, Integer> IDENTITY_SAML_RULE = Identities0.IDENTITY_SAML_RULE;
    ...
    private static class Identities0 {
        public static Identity<AdRuleRecord, Integer> IDENTITY_AD_RULE = Internal.createIdentity(AdRule.AD_RULE, AdRule.AD_RULE.ID);
        public static Identity<AuthChainRecord, Integer> IDENTITY_AUTH_CHAIN = Internal.createIdentity(AuthChain.AUTH_CHAIN, AuthChain.AUTH_CHAIN.ID);
        public static Identity<AuthInfoRecord, Integer> IDENTITY_AUTH_INFO = Internal.createIdentity(AuthInfo.AUTH_INFO, AuthInfo.AUTH_INFO.ID);
        public static Identity<ClientCertificateRuleRecord, Integer> IDENTITY_CLIENT_CERTIFICATE_RULE = Internal.createIdentity(ClientCertificateRule.CLIENT_CERTIFICATE_RULE, ClientCertificateRule.CLIENT_CERTIFICATE_RULE.ID);
        public static Identity<DeviseRuleRecord, Integer> IDENTITY_DEVISE_RULE = Internal.createIdentity(DeviseRule.DEVISE_RULE, DeviseRule.DEVISE_RULE.ID);
        public static Identity<DuoRuleRecord, Integer> IDENTITY_DUO_RULE = Internal.createIdentity(DuoRule.DUO_RULE, DuoRule.DUO_RULE.ID);
        public static Identity<FidoRuleRecord, Integer> IDENTITY_FIDO_RULE = Internal.createIdentity(FidoRule.FIDO_RULE, FidoRule.FIDO_RULE.ID);
        public static Identity<IpRuleRecord, Integer> IDENTITY_IP_RULE = Internal.createIdentity(IpRule.IP_RULE, IpRule.IP_RULE.ID);
        public static Identity<LoginIpRecord, Integer> IDENTITY_LOGIN_IP = Internal.createIdentity(LoginIp.LOGIN_IP, LoginIp.LOGIN_IP.ID);
        public static Identity<OtpRuleRecord, Integer> IDENTITY_OTP_RULE = Internal.createIdentity(OtpRule.OTP_RULE, OtpRule.OTP_RULE.ID);
        public static Identity<PasswordRuleRecord, Integer> IDENTITY_PASSWORD_RULE = Internal.createIdentity(PasswordRule.PASSWORD_RULE, PasswordRule.PASSWORD_RULE.ID);
        public static Identity<RootCertificateRecord, Integer> IDENTITY_ROOT_CERTIFICATE = Internal.createIdentity(RootCertificate.ROOT_CERTIFICATE, RootCertificate.ROOT_CERTIFICATE.ID);
        public static Identity<SamlRuleRecord, Integer> IDENTITY_SAML_RULE = Internal.createIdentity(SamlRule.SAML_RULE, SamlRule.SAML_RULE.ID);
